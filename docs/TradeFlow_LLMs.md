...
> This documentation is auto-generated by `scripts/update_doc.py`.
...
- `calculate_order_quantity(self, action: ActionType, current_position: int, price: float, total_equity: float, available_cash: float, lot_size: int = 1, signal: Optional[Dict[str, Any]] = None) -> int`
...
- `request_buy(self, symbol: str, quantity: int, callback: Optional[Callable]) -> None`

- `request_sell(self, symbol: str, quantity: int, callback: Optional[Callable]) -> None`
...
- `request_buy(self, symbol: str, quantity: int, callback: Callable) -> None`

  买入股票

- `request_sell(self, symbol: str, quantity: int, callback: Callable) -> None`
...
- `execute(self, symbol: str, price: float, action: ActionType, reason: str) -> TradeStatus`

- `sell(self, symbol: str, price: float) -> int`

  卖出股票 智能控仓

- `buy(self, symbol: str, price: float) -> int`

  买入股票 智能控仓

- `on_trade(self, trade: TradeRecord) -> None`
